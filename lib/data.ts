...
export const TRANSLATIONS = {
    ...
    footer: {
      ...
      browseTitle: "Selaa",
      casinoCategories: "Kasinokategoriat",
      offers: "Tarjoukset",
      depositMethods: "Talletustavat",
      withdrawalMethods: "Kotiutustavat",
      software: "Peliohjelmistot",
      vendors: "Pelivalmistajat",
      licences: "Kasinolicenssit",
      aboutSlotsband: "Tietoa SlotsBandista",
      howWeRate: "Arviointikriteerit",
      privacy: "Tietosuoja",
      terms: "Käyttöehdot",
    },
    contact: {
      ...
      twitchDesc: "Katso striimejä ja arvontoja livenä.",
      youtubeDesc: "Videokatsaukset, oppaat ja striimien parhaat hetket.",
      emailLabel: "Sähköposti",
      emailReveal: "Näytä osoite",
    ...
    about: {
      ...
      title: "Suomen luotetuin nettikasinoiden vertailusivusto",
      subtitle: "SlotsBand on perustettu 2018 auttamaan suomalaisia pelaajia löytämään turvallisimmat, luotettavimmat ja parhaiten bonuksia tarjoavat nettikasinot.",
      trust: [
      ...
      methodologyTitle: "Arviointimetodologia",
      methodologySubtitle: "Näin arvioimme kasinot — läpinäkyvästi ja rehellisesti.",
      methodology: [
      ...
      standardsTitle: "Toimitukselliset standardimme",
      standards: [
      ...
      ctaTitle: "Onko sinulla kysyttävää?",
      ctaSubtitle: "Tiimimme vastaa mielellään kasinoihin, bonuksiin tai sivustoomme liittyviin kysymyksiin.",
  ...
  en: {
    ...
    footer: {
      ...
      licences: "Casino Licences",
      aboutSlotsband: "About SlotsBand",
    ...
    contact: {
      ...
      twitchDesc: "Watch streams and giveaways live.",
      youtubeDesc: "Video reviews, guides and stream highlights.",
      emailLabel: "Email",
      emailReveal: "Show address",
    ...
    about: {
      eyebrow: "About Us",
      title: "Finland's Most Trusted Online Casino Comparison Site",
      subtitle: "SlotsBand was founded in 2018 to help players find the safest, most reliable online casinos with the best bonuses.",
      trust: [
        { value: "400+", label: "Casinos Reviewed" },
        { value: "8+", label: "Years of Experience" },
        { value: "150k+", label: "Monthly Visitors" },
        { value: "100%", label: "Unbiased" },
      ],
      methodologyTitle: "Our Review Methodology",
      methodologySubtitle: "How we evaluate casinos — transparently and honestly.",
      methodology: [
        { icon: "casino", title: "License Verification", desc: "We verify every casino's license for reliability — we favor MGA and UKGC licenses for safe, regulated play." },
        { icon: "payments", title: "Withdrawals Tested", desc: "We make real withdrawals from every casino. We measure actual withdrawal times, not advertised ones." },
        { icon: "redeem", title: "Bonus Terms Reviewed", desc: "We read bonus terms word for word and score wagering requirements, time limits, and other conditions." },
        { icon: "smartphone", title: "Mobile Experience", desc: "We test every casino on both Android and iOS devices to get a realistic mobile experience." },
        { icon: "support_agent", title: "Customer Support", desc: "We contact customer support with a range of questions to assess response time and expertise." },
        { icon: "security", title: "Security", desc: "We check SSL encryption, privacy policies, and responsible gambling tools with every review." },
      ],
      standardsTitle: "Our Editorial Standards",
      standards: [
        "We never accept payment for review ranking — placements are based solely on our scoring.",
        "All reviews are based on real testing carried out by our team.",
        "We update reviews regularly to keep them accurate and current.",
        "We report any changes to bonus terms immediately.",
        "Affiliate links fund the site but never influence our ratings.",
      ],
      ctaTitle: "Got a Question?",
      ctaSubtitle: "Our team is happy to help with anything about casinos, bonuses, or the site.",
  ...
  uk: {
    ...
    about: {
      eyebrow: "About Us",
      title: "The UK's Trusted Online Casino Comparison Site",
      subtitle: "SlotsBand was founded in 2018 to help UK players find safe, UKGC-licensed online casinos with the best bonuses.",
      trust: [
        { value: "400+", label: "Casinos Reviewed" },
        { value: "8+", label: "Years of Experience" },
        { value: "150k+", label: "Monthly Visitors" },
      ...
      methodologySubtitle: "How we evaluate casinos — transparently and honestly.",
      methodology: [
        { icon: "casino", title: "Licence Verification", desc: "We verify every casino's licence for reliability — we favour UKGC and MGA licences for safe, regulated play." },
        { icon: "payments", title: "Withdrawals Tested", desc: "We make real withdrawals from every casino. We measure actual withdrawal times, not advertised ones." },
        { icon: "redeem", title: "Bonus Terms Reviewed", desc: "We read bonus terms word for word and score wagering requirements, time limits, and other conditions." },
        { icon: "smartphone", title: "Mobile Experience", desc: "We test every casino on both Android and iOS devices to get a realistic mobile experience." },
        { icon: "support_agent", title: "Customer Support", desc: "We contact customer support with a range of questions to assess response time and expertise." },
