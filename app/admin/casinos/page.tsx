        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          {selected.length > 0 && (
            <div className="flex items-center gap-2">
              ...
              <button className="text-xs bg-[#FFD700]/20 text-[#775900] font-semibold px-3 py-1.5 rounded-lg hover:bg-[#FFD700]/30 transition-colors">
                Feature
              </button>
            </div>
          )}
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-[#E5E8F0]">
              {filtered.map((casino) => (
                <tr key={casino.id} className="hover:bg-[#F8F9FD] transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-sm font-bold text-[#1b1b1c]">{casino.rating.toFixed(1)}</span>
                    </div>
                  </td>
                  <td className="px-4 py-3">
