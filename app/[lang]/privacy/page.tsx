...
const LABELS: Record<Lang, { home: string; title: string; body: string }> = {
    ...
    body: "Tietosuojakäytäntömme on parhaillaan päivitettävänä. Palaa pian uudelleen.",
  },
  en: {
    home: "Home",
    title: "Privacy Policy",
    body: "Our privacy policy is currently being updated. Please check back soon.",
  },
  uk: {
    home: "Home",
    title: "Privacy Policy",
